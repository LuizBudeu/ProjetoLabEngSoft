...
urlpatterns = [
    ...
    path('relatorio/mostradia/',  views.mostrarelatoriodia, name='mostrarelatoriodia'),
    path('relatorio/mostrageral/',  views.mostrarelatoriogeral, name='mostrarelatoriogeral')
]
